...
/*==============================================================*/
/* DBMS name:      MySQL 5.0                                    */
/* Created on:     30/05/2022 15:29:58                          */
/*==============================================================*/
...
(
   CODIGO_ART           int not null auto_increment,
...
(
   NUMERO_CABECERA_INVEN int not null auto_increment,
...
(
   NUMERO_CABECERA_FACTU int not null auto_increment,
...
(
   NUMERO_CABECERA_FACT_CXC int not null auto_increment,
   CODIGO_CLI           int,
...
create table CIUDAD
(
   CODIGO_CIU           int not null auto_increment,
...
(
   CODIGO_COB           int not null auto_increment,
   NOM_COB              varchar(128),
   DIR_COB              varchar(128),
...
(
   CODIGO_FP            int not null auto_increment,
...
(
   CODIGO_TMOV          int not null auto_increment,
...
alter table CABECERA_COMPROBANTE_INVENTARIO add constraint FK_CABCERAINVENTARIO_TIPOMOVIMINETO foreign key (CODIGO_TMOV)
      references TIPOMOVIMIENTO (CODIGO_TMOV) on delete restrict on update restrict;
